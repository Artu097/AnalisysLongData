...
#include <iostream>
inline static std::size_t alloc{0};
inline static std::size_t dealloc{0};
...
template <typename T>
inline void GenericObject::construct(T *base, size_t count) {
...
template <typename T>
inline void GenericObject::destruct(T *base, size_t count) {
