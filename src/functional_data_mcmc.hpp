#ifndef FUNCTIONAL_DATA_MCMC_HPP
#define FUNCTIONAL_DATA_MCMC_HPP
...
#include "vector.hpp"
#include "random.hpp"
#include "normal_gamma_product.hpp"

typedef datamodels::normal_normalgamma_product datamodel;

#ifdef USE_R_RGN
#include <Rcpp.h>
#endif

class  functional_data_mcmc {
protected:
	//! Latest values
	typename datamodel::container_parameter c_th;
	_vector<unsigned int> c_d;
	_vector<unsigned int> c_N;

	//! Containers
	typename datamodel::container_parameter th;
...
public:
	functional_data_mcmc(const datamodel &dataModel) : dm(dataModel) { }
...
#ifdef USE_R_RGN
  void saveR(Rcpp::NumericMatrix &Rth, Rcpp::IntegerMatrix &Rd, Rcpp::IntegerMatrix &RN, Rcpp::IntegerVector &RNmax, Rcpp::IntegerMatrix &Rp, Rcpp::IntegerVector &Rk, Rcpp::NumericVector &Rl) {
...
#endif // FUNCTIONAL_DATA_MCMC_HPP
